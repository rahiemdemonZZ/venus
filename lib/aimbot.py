...
class Aimbot:
    ...
    def start(self):34
        ...
        half_screen_height = ctypes.windll.user32.GetSystemMetrics(1)/2 #this should always be 540 | 720
        print(half_screen_width, half_screen_height)
...
if __name__ == "__main__": print("You are in the wrong directory and are running the wrong file; you must run venus.py")
